...
**Note** : The input file must be placed at the same folder as the source code file demo_x.py, After running the source code you will get the output.txt file.
